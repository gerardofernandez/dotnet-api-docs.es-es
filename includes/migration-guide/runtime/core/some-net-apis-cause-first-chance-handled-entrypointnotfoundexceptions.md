### <a name="some-net-apis-cause-first-chance-handled-entrypointnotfoundexceptions"></a>Algunas API de .NET causa primera oportunidad (controlará) EntryPointNotFoundExceptions
